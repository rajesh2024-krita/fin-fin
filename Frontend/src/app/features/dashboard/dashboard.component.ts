        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-4">
            <div class="flex items-center">
              ...
              <span class="text-sm text-gray-600">New loan application submitted</span>
            </div>
            <div class="flex items-center">
              <div class="w-2 h-2 bg-green-400 rounded-full mr-3"></div>
              <span class="text-sm text-gray-600">Monthly demand processed for Society ABC</span>
            </div>
            <div class="flex items-center">
              <div class="w-2 h-2 bg-yellow-400 rounded-full mr-3"></div>
              <span class="text-sm text-gray-600">New member registration completed</span>
            </div>
          </div>
        </div>
